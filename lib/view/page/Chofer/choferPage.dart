...
class _ChoferpageState extends State<Choferpage> with WidgetsBindingObserver{
  ...
  // final Navegcioncontroller navegacioncontroller = Get.find<Navegcioncontroller>();
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Row(
                  children: [
                    ...
                    // 📌 Dropdown ocupa todo el espacio si el botón no se muestra
                    Flexible(
                      flex: 2, // Más prioridad al Dropdown
                      child: DropdownButtonHideUnderline(
                        child: Obx(() => DropdownButton2<String>(
                          ...
                          onChanged: (value) async {
                            ...
                            tubicacion.mapaCargada.value = false;
                    ...
                    // 📌 Botón que se muestra solo si el mapa está cargado
                    Obx(() {
                      if (tubicacion.mapaCargada.value) {
                        return Flexible(
                          flex: 1, // El botón ocupará menos espacio que el Dropdown
                              ...
                              Navegcioncontroller().showModalBottomSheetPreguntarAplicacion(
                                btnGoogleMaps: () async {
                                  ...
                                  if(res){
                                    ...
                                    // Navegcioncontroller().iniciarSeguimientoNavegacion();                                  
                                    Navigator.pop(context);
